...
static const struct fwk_element mhu_element_table[] = {
    [SCMI_CHANNEL_DEVICE_IDX_PSCI] = {
        ...
        .sub_element_count = 1,
    .data = &((struct mod_vring_mhu_channel_config) {
            .device_label = NULL,
            .driver_api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_VIRTIO_SMT,
                                             MOD_VIRTIO_SMT_API_IDX_DRIVER_INPUT),
        })
    },
    [SCMI_CHANNEL_DEVICE_IDX_OSPM_0] = {
        ...
        .sub_element_count = 2,
        .data = &((struct mod_vring_mhu_channel_config) {
            .device_label = DT_LABEL(DT_INST(0, virtio_mmio)),
            .driver_api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_VIRTIO_SMT,
                                             MOD_VIRTIO_SMT_API_IDX_DRIVER_INPUT),
        })
    },
    [SCMI_CHANNEL_DEVICE_IDX_OSPM_1] = {
        ...
        .sub_element_count = 2,
        .data = &((struct mod_vring_mhu_channel_config) {
            .device_label = DT_LABEL(DT_INST(1, virtio_mmio)),
            .driver_api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_VIRTIO_SMT,
                                             MOD_VIRTIO_SMT_API_IDX_DRIVER_INPUT),
        })
    },
...
struct fwk_module_config config_vring_mhu = {
...
static struct fwk_element smt_element_table[] = {
    [SCMI_SERVICE_IDX_PSCI] = {
        .name = "PSCI",
        .data = &((struct mod_virtio_smt_channel_config) {
            .type = MOD_VIRTIO_SMT_CHANNEL_TYPE_SLAVE,
            .driver_id = FWK_ID_SUB_ELEMENT_INIT(FWK_MODULE_IDX_VRING_MHU,
                                                 SCMI_CHANNEL_DEVICE_IDX_PSCI, 0),
            .driver_api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_VRING_MHU, 0),
        })
    },
    ...
    [SCMI_SERVICE_IDX_OSPM_0_P2A] = {
        .name = "OSPM0 P2A",
        .data = &((struct mod_virtio_smt_channel_config) {
            .type = MOD_VIRTIO_SMT_CHANNEL_TYPE_MASTER,
            .driver_id = FWK_ID_SUB_ELEMENT_INIT(FWK_MODULE_IDX_VRING_MHU,
...
struct fwk_module_config config_virtio_smt = {
