...
static const struct fwk_element mbx_element_table[] = {
    [SCMI_CHANNEL_DEVICE_IDX_PSCI] = {
        ...
        .sub_element_count = 1,
    .data = &((struct mod_vring_mbx_channel_config) {
            .device_label = NULL,
...
struct fwk_module_config config_vring_mbx = {
...
static struct fwk_element smt_element_table[] = {
    [SCMI_SERVICE_IDX_PSCI] = {
        ...
        .data = &((struct mod_msg_smt_channel_config) {
            ...
            .driver_id = FWK_ID_SUB_ELEMENT_INIT(FWK_MODULE_IDX_VRING_MBX,
                                                 SCMI_CHANNEL_DEVICE_IDX_PSCI, 0),
            .driver_api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_VRING_MBX, 0),
        })
    },
