	...
	[CONFIG_POWER_DOMAIN_SYSTOP_CHILD_CLUSTER0] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            ...
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_VPPU, PPU_V0_ELEMENT_IDX_CLUSTER),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_VPPU, 0),
	...
	[CONFIG_POWER_DOMAIN_SYSTOP_CHILD_DBGTOP] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            ...
            .tree_pos = MOD_PD_TREE_POS(
                ...
                0),
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_VPPU, PPU_V0_ELEMENT_IDX_DBGTOP),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_VPPU, 0),
    ...
    [CONFIG_POWER_DOMAIN_SYSTOP_CHILD_DPU0TOP] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            ...
            .tree_pos = MOD_PD_TREE_POS(
                ...
                0),
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_VPPU, PPU_V0_ELEMENT_IDX_DPU0TOP),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_VPPU, 0),
            .allowed_state_mask_table = toplevel_allowed_state_mask_table,
            .allowed_state_mask_table_size =
                FWK_ARRAY_SIZE(toplevel_allowed_state_mask_table)
    ...
    [CONFIG_POWER_DOMAIN_SYSTOP_CHILD_DPU1TOP] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            ...
            .tree_pos = MOD_PD_TREE_POS(
                ...
                0),
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_VPPU, PPU_V0_ELEMENT_IDX_DPU1TOP),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_VPPU, 0),
            .allowed_state_mask_table = toplevel_allowed_state_mask_table,
            .allowed_state_mask_table_size =
                FWK_ARRAY_SIZE(toplevel_allowed_state_mask_table)
    ...
    [CONFIG_POWER_DOMAIN_SYSTOP_CHILD_GPUTOP] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            ...
            .tree_pos = MOD_PD_TREE_POS(
                ...
                0),
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_VPPU, PPU_V0_ELEMENT_IDX_GPUTOP),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_VPPU, 0),
            .allowed_state_mask_table = toplevel_allowed_state_mask_table,
            .allowed_state_mask_table_size =
                FWK_ARRAY_SIZE(toplevel_allowed_state_mask_table)
    ...
    [CONFIG_POWER_DOMAIN_SYSTOP_CHILD_VPUTOP] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            ...
            .tree_pos = MOD_PD_TREE_POS(
                ...
                0),
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_VPPU, PPU_V0_ELEMENT_IDX_VPUTOP),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_VPPU, 0),
            .allowed_state_mask_table = toplevel_allowed_state_mask_table,
            .allowed_state_mask_table_size =
                FWK_ARRAY_SIZE(toplevel_allowed_state_mask_table)
    ...
    [CONFIG_POWER_DOMAIN_SYSTOP_CHILD_COUNT] = {
        ...
        .data = &((struct mod_power_domain_element_config) {
            ...
            .tree_pos = MOD_PD_TREE_POS(
                ...
                0),
            .driver_id = FWK_ID_ELEMENT_INIT(
                FWK_MODULE_IDX_VPPU, PPU_V0_ELEMENT_IDX_SYS0),
            .api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_VPPU, 0),
            .allowed_state_mask_table = toplevel_allowed_state_mask_table,
            .allowed_state_mask_table_size =
                FWK_ARRAY_SIZE(toplevel_allowed_state_mask_table)
    ...
    (fwk_id_t module_id)
{
    ...
    pd_config_table = fwk_mm_calloc(host_core_get_count(),
	...
	FWK_HOST_PRINT("[PD] sgm775_power_domain_get_element_table idx %04x \n", core_idx);
        ...
        pd_config->attributes.pd_type = MOD_PD_TYPE_DEVICE,
        pd_config->tree_pos = MOD_PD_TREE_POS(
            ...
            CONFIG_POWER_DOMAIN_SYSTOP_CHILD_CLUSTER0,
            core_idx),
        pd_config->driver_id = FWK_ID_ELEMENT(FWK_MODULE_IDX_VPPU, core_idx),
        pd_config->api_id = FWK_ID_API(
            FWK_MODULE_IDX_VPPU, 0),
