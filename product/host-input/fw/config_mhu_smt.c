...
struct fwk_module_config config_input_mhu = {
...
static struct fwk_element smt_element_table[] = {
    [SCMI_SERVICE_IDX_PSCI] = {
        ...
        .data = &((struct mod_virtio_smt_channel_config) {
            ...
            .driver_id = FWK_ID_SUB_ELEMENT_INIT(FWK_MODULE_IDX_INPUT_MHU,
                                                 SCMI_CHANNEL_DEVICE_IDX_PSCI, 0),
            .driver_api_id = FWK_ID_API_INIT(FWK_MODULE_IDX_INPUT_MHU, 0),
        })
    },
