...
ifeq ($(BS_FIRMWARE_HAS_SENSOR_MULTI_AXIS),yes)
    BUILD_HAS_SENSOR_MULTI_AXIS := yes
else
    BUILD_HAS_SENSOR_MULTI_AXIS := no
endif

ifeq ($(BS_FIRMWARE_HAS_SENSOR_EXT_ATTRIBS), yes)
    BUILD_HAS_SENSOR_EXT_ATTRIBS := yes
else
    BUILD_HAS_SENSOR_EXT_ATTRIBS := no
endif
