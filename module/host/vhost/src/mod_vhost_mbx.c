...
struct mbx_device_ctx {
    ...
    struct mod_vhost_mbx_channel_config *config;
...
void vhost_signal_message(struct mbx_device_ctx *device_ctx, unsigned int channel_idx, VuVirtqElement *elem)
{
...
{
    struct mbx_device_ctx *device_ctx = container_of(dev, struct mbx_device_ctx, dev.parent);
...
static int vscmi_init_channels(struct mbx_device_ctx *device_ctx);

static gpointer server_wait_vm_thread(gpointer data)
{
    struct mbx_device_ctx *device_ctx = (struct mbx_device_ctx *)data;
...
static void vscmi_destroy_channels(struct mbx_device_ctx *device_ctx);
                           ...
                           const void *data)
{
    ...
    device_ctx->config = (struct mod_vhost_mbx_channel_config*)data;
...
/* VHOST_MBX module definition */
const struct fwk_module module_vhost_mbx = {
