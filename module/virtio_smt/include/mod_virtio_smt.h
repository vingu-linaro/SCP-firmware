...
#ifndef MOD_VIRTIO_SMT_H
#define MOD_VIRTIO_SMT_H
 ...
 */
enum mod_virtio_smt_channel_type {
    /*! Master channel */
    MOD_VIRTIO_SMT_CHANNEL_TYPE_MASTER,

    /*! Slave channel */
    MOD_VIRTIO_SMT_CHANNEL_TYPE_SLAVE,

    /*! Channel type count */
    MOD_VIRTIO_SMT_CHANNEL_TYPE_COUNT,
};

/*!
 * \brief Channel config.
 */
struct mod_virtio_smt_channel_config {
    /*! Channel role (slave or master) */
    enum mod_virtio_smt_channel_type type;
 ...
 */
struct mod_virtio_smt_driver_input_api {
    /*!
 ...
 */
struct mod_virtio_smt_driver_ouput_api {
    /*!
     * \brief Signal an incoming message in the mailbox
     *
     * \param device_id Channel identifier
 ...
 */
enum mod_virtio_smt_api_idx {
    MOD_VIRTIO_SMT_API_IDX_SCMI_TRANSPORT,
    MOD_VIRTIO_SMT_API_IDX_DRIVER_INPUT,
    MOD_VIRTIO_SMT_API_IDX_COUNT,
};

#endif /* MOD_VIRTIO_SMT_H */
